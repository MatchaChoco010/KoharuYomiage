    ...
    public class VoiceParameterUpdater : IStartUpdatingVoiceParameter, IDisposable
    {
        ...
        public async Task Start(CancellationToken cancellationToken)
        {
            ...
            _disposable = notifier.VoiceParameter.Subscribe(param =>
                _updateVoiceParameter.Update(new VoiceParameterData(param.GlobalVolume, param.Volume, param.Speed,
                    param.Tone, param.Alpha, param.ToneScale, param.ComponentNormal, param.ComponentHappy,
                    param.ComponentAnger, param.ComponentSorrow, param.ComponentCalmness)));
